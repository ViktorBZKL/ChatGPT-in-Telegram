...
## Установка
Перед началом работы получите ключ для создания бота Telegram от BotFather. После чего последовательно введите следующие команды:
```commandline
git clone https://github.com/ViktorBZKL/ChatGPT-in-Telegram.git
pip install -r requirements.txt
```
После выполнения данных действий вставьте, полученный ранее API в файл `.env`, в переменную `Bot` ключ от бота.
